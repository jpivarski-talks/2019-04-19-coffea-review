...
\vspace{0.5 cm}
\uncover<3->{So far, in my work, Ben's, and Andrew's, Coffea has been \underline{\it the} real-world use-case. In Analysis Systems we are, of course, expanding to include at least one ATLAS analysis, but so far nearly all of the visible momentum has been from this project.}
\end{frame}
